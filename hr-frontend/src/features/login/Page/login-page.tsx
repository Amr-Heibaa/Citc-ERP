...
export function LoginPage() {
  ...
  return (
    ...
    >
      {/* Decorative circles */}
      <div
        className="absolute right-10 -top-28 size-[360px] rounded-full pointer-events-none"
        style={{ background: "rgba(31,241,245,0.10)" }}
      />
      <div
        className="absolute -bottom-28 -left-20 size-[280px] rounded-full pointer-events-none"
        style={{ background: "rgba(46,204,113,0.13)" }}
      />
      <div
        className="absolute bottom-4 right-52 size-[220px] rounded-[32px] rotate-[18deg] pointer-events-none"
        style={{ background: "rgba(30,144,255,0.08)" }}
      />

      {/* Main card */}
      <div
        className="relative flex rounded-[20px] overflow-hidden shadow-2xl"
        style={{ width: "min(900px, 95vw)", minHeight: "520px" }}
      >
        {/* Left panel – branding */}
        <div
          className="flex flex-col items-center justify-center gap-6 px-10 py-12"
          style={{ background: "#f3f3f3", flex: "0 0 38%" }}
        >
        ...
        {/* Right panel – form */}
        <div
          className="flex items-center justify-center flex-1 py-12 px-10"
        ...
        >
          ...
          >
            ...
            <Button
              ...
              style={{
                background: "#72cfe9",
                boxShadow: "0 10px 12px rgba(114,207,233,0.25)",
              }}
            >
              {isLoading ? (
