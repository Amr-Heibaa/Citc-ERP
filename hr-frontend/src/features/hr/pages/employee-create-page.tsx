...
export function EmployeeCreatePage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: unknown) => {
      toast.error((error as { message?: string })?.message ?? 'Failed to create employee')
    },
  })
      ...
      <Form {...form}>
        ...
        >
          ...
          <Section title="Employment">
            <TextField control={control} name="employeeNumber" label="Employee Number" required placeholder="EMP-0016" />
            ...
            <TextField control={control} name="hireDate" label="Hire Date" type="date" />
            <TextField control={control} name="startDate" label="Start Date" type="date" />
          </Section>

          {/* PERSONAL */}
          <Section title="Personal">
            <TextField control={control} name="firstName" label="First Name" required placeholder="Ahmed" />
            <TextField control={control} name="otherName" label="Other Name" required placeholder="Mohamed Ali" />
            <TextField control={control} name="displayName" label="Display Name" placeholder="Ahmed Ali" />
            ...
            <TextField control={control} name="nationalId" label="National ID" placeholder="29001011234567" />
          </Section>

          {/* CONTACT */}
          <Section title="Contact">
            <TextField control={control} name="personalEmail" label="Personal Email" type="email" placeholder="ahmed@gmail.com" />
            <TextField control={control} name="businessEmail" label="Business Email" type="email" placeholder="ahmed@citec.local" />
            <TextField control={control} name="phoneNumber" label="Phone Number" placeholder="02xxxxxxxx" />
            <TextField control={control} name="mobileNumber" label="Mobile Number" placeholder="010xxxxxxxx" />
          </Section>
