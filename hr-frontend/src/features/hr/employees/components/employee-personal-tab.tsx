...
export function PersonalTab({ emp }: { emp: EmployeeDetail }) {
  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      <div>
        ...
        <div className="flex gap-4">
          ...
          <div className="grid flex-1 grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            />
            <InfoRow
              label={t("employees.fields.otherName")}
              value={emp.otherName}
            />
            <InfoRow
              label={t("employees.fields.displayName")}
              value={emp.displayName}
            />
            <InfoRow
              label={t("employees.fields.gender")}
              value={emp.genderLabel}
            />
            <InfoRow
      ...
      <div>
        <SectionTitle>
          {t("employees.sections.officialInformation")}
        </SectionTitle>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <InfoRow
            label={t("employees.fields.graduationDate")}
            value={formatDate(emp.graduationDate)}
          />

          <InfoRow
            label={t("employees.fields.specialization")}
          ...
          <InfoRow
            ...
            value={
              emp.totalExperienceYears != null
                ? t("employees.fields.totalExperienceYears", {
                    count: emp.totalExperienceYears,
                  })
                : null
            }
          />
          ...
          <InfoRow
            label={t("employees.fields.workLocation")}
            value={emp.workLocationName ?? emp.workLocation}
          />
          <InfoRow
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          />
          <InfoRow
            label={t("employees.fields.businessEmail")}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          <InfoRow
            label={t("employees.fields.addressLine1")}
            value={emp.addressLine1}
          />
          <InfoRow
            label={t("employees.fields.addressLine2")}
            value={emp.addressLine2}
          />
          <InfoRow
            label={t("employees.fields.postalCode")}
